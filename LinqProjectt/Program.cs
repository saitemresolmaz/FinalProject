    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>() {
                ...
                new Product { ProductId=5, CategoryId=2,ProductName="Apple Telefon",QuantityPerUnit="2 Gb Ram",UnitPrice =8000,UnitsInStock=0}
            };
        ...
        //Algoritmik olarak (Linq) olmadan yaparsak
